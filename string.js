...
// 2. Write a Javascript to split the following string.
// Sample string : '082307'
// Expected Output : 08:23:07

// 3. Write a Javascript to check whether a string contains a specific string?
// Sample string : 'The quick brown fox jumps over the lazy dog.'
// Check whether the said string contains the string 'jumps'.

// 4. Write a Javascript to convert the value of a PHP variable to string.
...
// 7. Write a Javascript to get the last three characters of a string.
// Sample String : 'rayy@example.com'
// Expected Output : 'com'

// 8. Write a Javascript to format values in currency style.
// Sample values : value1 = 65.45, value2 = 104.35
// Expected Result : 169.80

// 9. Write a Javascript to generate simple random password [do not use rand() function] from a given string.
// Sample string : '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcefghijklmnopqrstuvwxyz'
// Note : Password length may be 6, 7, 8 etc.

// 10. Write a Javascript to replace the first 'the' of the following string with 'That'.
// Sample date : 'the quick brown fox jumps over the lazy dog.'
// Expected Result : That quick brown fox jumps over the lazy dog.

// 11. Write a Javascript to find the first character that is different between two strings.
// String1 : 'football'
// String2 : 'footboll'
// Expected Result : First difference between two strings at position 5: "a" vs "o"

// 12. Write a Javascript to put a string in an array.
...
// 13. Write a Javascript to get the filename component of the following path.
// Sample path : "https://www.w3resource.com/index.php"
// Expected Output : 'index'

// 14. Write a Javascript to print the next character of a specific character.
// Sample character : 'a'
// Expected Output : 'b'
// Sample character : 'z'
// Expected Output : 'a'
...
// 15. Write a Javascript to remove a part of a string from the beginning.
// Sample string : 'rayy@example.com'
// Expected Output : 'example.com'

// 16. Write a Javascript to get a hex dump of a string.
// Sample string : 'rayy@example.com'

// 17. Write a Javascript to insert a string at the specified position in a given string.
// Original String : 'The brown fox'
// Insert 'quick' between 'The' and 'brown'.
// Expected Output : 'The quick brown fox'
// Click me to the see solution

// 18. Write a Javascript to get the first word of a sentence.
// Original String : 'The quick brown fox'
// Expected Output : 'The'

// 19. Write a Javascript to remove all leading zeroes from a string.
// Original String : '000547023.24'
// Expected Output : '547023.24'

// 20. Write a Javascript to remove part of a string.
// Original String : 'The quick brown fox jumps over the lazy dog'
// Remove 'fox' from the above string.
// Expected Output : 'The quick brown jumps over the lazy dog'

// 21. Write a Javascript to remove trailing slash from a string.
// Original String : 'The quick brown fox jumps over the lazy dog///'
// Expected Output : 'The quick brown fox jumps over the lazy dog'

// 22. Write a Javascript to get the characters after the last '/' in an url.
// Sample URL : 'http://www.example.com/5478631'
// Expected Output : '5478631'

// 23. Write a Javascript to replace multiple characters from the following string.
// Sample String : '\"\1+2/3*2:2-3/4*3'
// Expected Output : '1 2 3 2 2 3 4 3'

// 24. Write a Javascript to select first 5 words from the following string.
// Sample String : 'The quick brown fox jumps over the lazy dog'
// Expected Output : 'The quick brown fox jumps'

// 25. Write a Javascript to remove comma(s) from the following numeric string.
// Sample String : '2,543.12'
// Expected Output : 2543.12

// 26. Write a Javascript to print letters from 'a' to 'z'.
